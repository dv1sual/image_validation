...
logger = configure_logger('aces2065', 'aces2065.log')
...
def main():
    """Main function to orchestrate loading, validation, and visualization of the color chart."""
    try:
        with open('color_charts_values/color_chart_values.json', 'r') as json_file:
            local_color_charts = json.load(json_file)
    except json.JSONDecodeError:
        logger.error("Error parsing JSON file. Please ensure it is in the correct format.")
        return
    ...
    chart_values = local_color_charts[
        'aces2065_1_color_chart_values'] if "ACES2065_1" in input_image_path else local_color_charts
